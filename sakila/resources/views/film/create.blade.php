...
<div class="row">
	...
	<div class="form-group col-md-4">	
		...
		{!! Form::select('actor_id[]',$actors, null, ['class'=>'form-control select-actor','multiple','required']) !!}
	</div>
	
	<div class="form-group col-md-4">	

	 	{!! Form::label('category_id','Categoria:')!!}
		{!! Form::select('category_id[]',$categories, null, ['class'=>'form-control select-category','multiple','required']) !!}

		<h3>Texto de la Pelicula</h3><hr>
		{!!Form::label('title2','Titulo:')!!}
		{!!Form::text('title2', null, ['class'=>'form-control','required'])!!}

		{!!Form::label('description2','Descripcion:')!!}
		{!!Form::textarea('description2', null,['class'=>'form-control', 'rows'=>'3','required'])!!}
	</div>
